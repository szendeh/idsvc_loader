...
prependUrl = 'http://localhost:8080/claim/'
appendUrl = ''
...
def testLine(line):
    ...
    try:
        ...
        if mit_id and name_literal and handle:
            ...
            r = requests.put(prependUrl + mit_id +'?wid='+ handle.group(1), data=json.dumps(data_object), headers = {'content-type': 'application/json'})
